...
export function ImagesSliderDemo() {
  ...
  const words = [" Frontend Developer","Web Developer", "backend developer", "Full Stack Developer"];
  const images = [
    ...
    <ImagesSlider className="h-[40rem] -mt-4" images={images}>
      ...
      >
        <motion.div className="relative ">
            ...
            <a href="https://www.instagram.com/sujonbiswaseng" className="text-3xl text-white border-none outline-none cursor-pointer "><FaInstagramSquare/></a>
            <a href="https://www.linkedin.com/in/sujonbiswaseng" className="text-3xl text-white border-none outline-none cursor-pointer">
            <FaLinkedin/></a>
            ...
            <a className="text-3xl text-white border-none outline-none cursor-pointer" href="https://github.com/sujonbiswaseng"><FaGithub /></a>
          </div>
              ...
              <div className="pt-4 pb-4 flex sm:flex-row flex-col items-center gap-5">
                <motion.a
                  whileHover={{ scale: 1.08, boxShadow: "0px 4px 24px 0px #FD6F0055" }}
                  whileTap={{ scale: 0.97 }}
